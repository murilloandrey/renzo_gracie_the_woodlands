...
const disciplines = [
  { n: "01", title: "Adult BJJ", tag: "The Art of Control", img: adultBjj },
  {
    n: "02",
    title: "Muay Thai",
    tag: "The Science of Eight Limbs",
    img: muayThai,
  },
  {
    n: "03",
    title: "Kids & Teens",
    tag: "Building Unshakable Confidence",
    img: kidsBjj,
    note: "Age-appropriate classes from age 4 up — Junior Members, Kids Gi, Teens, and a Competition class. Discipline that lasts a lifetime.",
  },
...
const testimonials = [
  {
    name: "Boyd",
    role: "Visiting Grappler",
    quote:
      "Visiting from out of town and they welcomed me in for a drop-in immediately. High-level technique on the mats — exactly what you want from a Renzo affiliate.",
  },
  {
    name: "James",
    role: "Out-of-Town Dad",
    quote:
      "Drove in with my son and he got to roll with Professor Todd — a 4th-degree black belt. They treated us like family from the first handshake.",
  },
  {
    name: "Martin",
    role: "Parent",
    quote:
      "My 6-year-old daughter was nervous her whole first class. Coach Oli helped her every single step, and by the end she was laughing. We never looked back.",
  },
  {
    name: "Anthony",
    role: "Adult Beginner",
    quote:
      "Felt part of the community from day one. Coach Phillipe breaks down the Muay Thai combos so clearly that even a total beginner gets it fast.",
  },
];
...
const faqs = [
  {
    ...
    a: "None at all. Most of our students walked in as complete beginners. Our coaches are experts at meeting you exactly where you are — your only job is to show up.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. Training is progressive, supervised, and technique-first. You'll learn to tap early and train responsibly from day one.",
  },
  {
    q: "How young can my child start?",
    a: "Typically ages 4–5, depending on focus and maturity, with age-specific groups all the way through teens.",
  },
  {
    q: "How often should I train?",
    a: "2–3 times per week is ideal for a beginner. Consistency beats intensity — show up regularly and progress will follow.",
  },
];
...
function Stars() {
  return (
    <div className="flex gap-1 text-bone">
    ...
    <div className="min-h-screen bg-obsidian text-bone">
      ...
      <section className="grain relative min-h-[100svh] overflow-hidden">
        ...
        <div className="relative z-10 flex items-center justify-between px-6 pt-6 md:px-12 md:pt-8">
          <div className="flex items-center gap-4 md:gap-6">
            <img
              src={logo}
              alt="Renzo Gracie The Woodlands"
              className="logo-white h-10 w-10 md:h-12 md:w-12"
            />
          ...
          <div className="flex items-center gap-4 text-xs md:gap-8">
            ...
            <a
              ...
              className="font-display flex items-center gap-2 tracking-[0.18em] hover:text-primary"
            >
        ...
        <div className="relative z-10 flex min-h-[calc(100svh-6rem)] flex-col justify-end px-6 pb-16 pt-24 md:px-12 md:pb-24">
          <div className="max-w-5xl">
            ...
            <div className="mt-8 flex gap-5 text-muted-foreground">
              ...
              <a
                href="https://facebook.com/renzograciethewoodlands1"
                aria-label="Facebook"
                className="hover:text-primary transition-colors"
              >
                <Facebook size={20} />
          ...
          {disciplines.map((d) => (
            ...
            >
              ...
              <div className="relative flex h-full flex-col justify-end p-6">
                <div className="font-display text-4xl text-muted-foreground mb-3">
                  {d.n}
                </div>
      ...
      >
        <SectionHeader
          ...
          note={
            <>
              Filter by discipline to find your classes. Drop-ins welcome — just
        ...
        <div className="mt-10 flex items-center justify-between gap-4">
          <p className="text-xs text-muted-foreground">
            Schedule subject to seasonal updates. Call or text to confirm
            today's classes.
          </p>
          <Link to="/free-trial" className="btn-primary">
        ...
        <div className="grid gap-16 md:grid-cols-2">
          <div>
            ...
            <p className="mt-6 max-w-md text-sm text-muted-foreground">
              You don't need to be in shape. You don't need to know a single
              move. You don't need to be "tough." You just need to walk through
          ...
          <div className="space-y-6">
            {[
              {
                n: "01",
                t: "Arrive 10 Minutes Early",
                d: "Give yourself time to sign the waiver and meet the coach. No rush — we've got you.",
              },
              {
                n: "02",
              ...
              {
                n: "03",
                t: "Train At Your Pace",
                d: "A coach will help you get set up and guide every drill. Tap early, learn steadily, enjoy the process.",
              },
            ].map((s) => (
              <div
                key={s.n}
                className="grid grid-cols-[auto_1fr] gap-8 border-t border-border pt-6"
              >
                <div className="font-display text-3xl text-muted-foreground/70 leading-none">
                  {s.n}
                </div>
                <div>
      ...
      <section className="border-t border-border px-6 py-20 md:px-12 md:py-32">
        <div className="mb-12">
          ...
          <p className="mt-4 text-sm text-muted-foreground">
            We're not for everyone — and that's the point. Here's the straight
            truth.
          </p>
        </div>
      ...
      <section className="border-t border-border px-6 py-20 md:px-12 md:py-32">
        <div className="grid gap-12 md:grid-cols-[1fr_2fr]">
          <div>
            ...
            <p className="mt-4 text-sm text-muted-foreground">
              Still unsure? Call or text us — we answer every question, no
              pressure.
            </p>
          </div>
          <div>
            {faqs.map((f, i) => (
              <div key={i} className="border-t border-border last:border-b">
                ...
                >
                  <span
                    className={`font-display text-sm tracking-[0.12em] ${openFaq === i ? "text-primary" : "text-bone"}`}
                  >
                    {f.q}
                  </span>
                  {openFaq === i ? (
        ...
        <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <div className="mt-1 text-xs text-muted-foreground">
                    Hours: Mon–Sat · See weekly schedule
                  </div>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <div className="mt-1 text-xs text-muted-foreground">
                    We respond to texts throughout the day.
                  </div>
                </div>
              </div>
              <div className="flex gap-4">
          ...
          <div className="min-h-[400px] overflow-hidden border border-border">
            <iframe
              ...
              style={{
                filter:
                  "grayscale(1) invert(0.92) hue-rotate(180deg) contrast(0.95) brightness(0.95)",
              }}
