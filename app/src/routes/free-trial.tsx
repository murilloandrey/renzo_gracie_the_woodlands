          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2">
            <div className="border border-border bg-card p-8 space-y-6">
              <Info
                icon={MapPin}
                title="Address"
                body="9391 Grogan's Mill Rd Ste B12, The Woodlands, Texas"
                sub="Hours: Mon–Sat · See weekly schedule"
              />
              <Info
                icon={Phone}
                title="Call or Text"
                body="(832) 584-0565"
                sub="We respond to texts throughout the day."
              />
              <Info
                icon={Mail}
                title="Email"
                body="info@renzograciethewoodlands.com"
              />
