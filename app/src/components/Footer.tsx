      ...
      <div className="mx-auto grid max-w-7xl gap-10 md:grid-cols-3">
        <div>
          <img
            ...
            className="logo-white h-14 w-14"
          />
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-muted-foreground">
            ...
            <li className="flex gap-3">
              ...
              <a href="tel:+18325840565" className="hover:text-bone">
                (832) 584-0565
              </a>
            </li>
            <li className="flex gap-3">
              <MessageSquare size={16} className="mt-1 shrink-0" />
              <a href="sms:+18325840565" className="hover:text-bone">
                Text Us
              </a>
            </li>
            <li className="flex gap-3">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-muted-foreground">
            <li>
              <Link to="/" hash="disciplines" className="hover:text-bone">
                Programs
              </Link>
            </li>
            <li>
              <Link to="/" hash="schedule" className="hover:text-bone">
                Weekly Schedule
              </Link>
            </li>
            <li>
              <Link to="/" hash="first-day" className="hover:text-bone">
                Your First Day
              </Link>
            </li>
            <li>
              <Link to="/" hash="coaches" className="hover:text-bone">
                Coaches
              </Link>
            </li>
            <li>
              <Link to="/" hash="location" className="hover:text-bone">
                Location
              </Link>
            </li>
            <li>
